...
export function DesktopHeader() {
  ...
  return <header className="hidden md:block bg-background/95 backdrop-blur-sm border-b border-border">
      <div className="container mx-auto flex items-center justify-between px-6 py-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <img src="https://bramvnherjbaiakwfvwb.supabase.co/storage/v1/object/public/lottery-images/Site_name-removebg-preview.png" alt="Fortune Bridge" className="h-40 object-contain" />
        </div>

        {/* Right side - FC Balance, Auth, Menu */}
        <div className="flex items-center gap-4">
          {user && <>
              <Button variant="ghost" onClick={handleWalletClick} className="flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full border border-primary/20 shadow-sm hover:bg-primary/15 transition-colors">
              ...
              <Button variant="ghost" onClick={handleReferralClick} className="flex items-center gap-2 px-4 py-2 bg-green-500/10 rounded-full border border-green-500/20 shadow-sm hover:bg-green-500/15 transition-colors">
          ...
          {user && <Button variant="ghost" onClick={handleSignOut} className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-background/95 backdrop-blur-sm border border-border shadow-lg">
              ...
              {user && <DropdownMenuItem onClick={() => navigate('/my-tickets')} className="cursor-pointer">
