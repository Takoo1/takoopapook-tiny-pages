...
export function MobileHeader() {
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border pt-safe-top h-[56px]">
      <div className="flex items-center justify-between px-4 py-1.5 h-full">
        ...
        <>
              <Button variant="ghost" onClick={handleWalletClick} className="flex items-center gap-1.5 px-3 py-1.5 bg-primary/10 rounded-full border border-primary/20 shadow-sm hover:bg-primary/15 transition-colors">
              ...
              <Button variant="ghost" onClick={handleReferralClick} className="flex items-center gap-1.5 px-2 py-1.5 bg-green-500/10 rounded-full border border-green-500/20 shadow-sm hover:bg-green-500/15 transition-colors">
        ...
        <Button size="sm" onClick={handleSignUpPrompt} className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white font-medium px-4 py-2 text-xs rounded-full shadow-md hover:shadow-lg transition-all duration-200">
