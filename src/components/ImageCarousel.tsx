  ...
  return <section className="py-8 bg-gradient-to-r from-primary/5 to-accent/5">
      ...
      <div className="space-y-3">
              <h2 className="text-3xl md:text-5xl font-bold text-center text-foreground px-4 whitespace-nowrap">
                Why Choose <img src="https://bramvnherjbaiakwfvwb.supabase.co/storage/v1/object/public/lottery-images/Site_name-removebg-preview.png" alt="Fortune Bridge" className="inline-block h-9 max-w-fit object-contain" />?
              </h2>
