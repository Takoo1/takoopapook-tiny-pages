        ...
        {isMobile ? (
          ...
          <div className="space-y-3">
            <h2 className="text-2xl md:text-4xl font-bold text-center text-foreground px-4 whitespace-nowrap">
              Why Choose <img src="https://bramvnherjbaiakwfvwb.supabase.co/storage/v1/object/public/lottery-images/Site_name.png" alt="Fortune Bridge" className="inline-block h-6 object-contain" />?
            </h2>
          ...
          <div className="grid grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <h2 className="text-2xl md:text-4xl font-bold text-foreground whitespace-nowrap text-center">
                Why Choose <img src="https://bramvnherjbaiakwfvwb.supabase.co/storage/v1/object/public/lottery-images/Site_name.png" alt="Fortune Bridge" className="inline-block h-8 md:h-10 object-contain" />?
              </h2>
            </div>
            <div className="relative overflow-hidden rounded-2xl shadow-card">
              <div 
