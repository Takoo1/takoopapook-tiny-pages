...
import { formatDateWithTimezone, formatDateTimeForDatabase, formatDateTimeForInput } from "@/lib/dateUtils";
  ...
  useEffect(() => {
    if (editingGame) {
      setFormData({
        ...
        gameDate: editingGame.game_date ? formatDateTimeForInput(editingGame.game_date, editingGame.organizer_timezone) : '',
        stopBookingTime: editingGame.stop_booking_time ? formatDateTimeForInput(editingGame.stop_booking_time, editingGame.organizer_timezone) : '',
    ...
    try {
      ...
      if (editingGame) {
        ...
        const updateData: any = {
          ...
          game_date: formData.gameDate ? formatDateTimeForDatabase(formData.gameDate, organizerTimezone) : null,
          stop_booking_time: formData.stopBookingTime ? formatDateTimeForDatabase(formData.stopBookingTime, organizerTimezone) : null,
