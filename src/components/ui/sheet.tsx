...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card text-card-foreground p-6 shadow-[0_-8px_40px_-8px_hsl(var(--foreground)/0.25)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
