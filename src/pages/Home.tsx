...
export default function Home() {
  ...
  return (
    <div className="home-noir min-h-screen relative font-['Manrope']">
      ...
      <section className="home-band-dark px-5 md:px-6 pt-2 pb-3">
        <div className="max-w-6xl mx-auto flex justify-between items-center gap-8 overflow-x-auto no-scrollbar home-chip-row py-2">
          ...
          <div className="home-chip">
            <div className="ico"><Stamp className="w-5 h-5" /></div>
            <span className="lbl">Verified</span>
          </div>
          <div className="home-chip">
            <div className="ico"><BadgePercent className="w-5 h-5" /></div>
            <span className="lbl">Discounted</span>
          </div>
        </div>
      </section>
