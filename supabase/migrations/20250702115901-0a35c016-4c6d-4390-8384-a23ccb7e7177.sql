...
ALTER TABLE public.locations DROP CONSTRAINT IF EXISTS locations_coordinates_x_check;
ALTER TABLE public.locations DROP CONSTRAINT IF EXISTS locations_coordinates_y_check;
