...
7. Make the "Select Tickets"/"Buy Now" button in the floating bar in the game details page gloden [glossy.  In the ticket numbers list, when a ticket is selected and then clicked again to un select, the colour of the ticket still stays same as if it is selected, fix this and make the ticket numbers colour light blue glossy](http://glossy.Buy)
